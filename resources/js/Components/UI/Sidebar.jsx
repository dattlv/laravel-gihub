...
export default function Sidebar({ isCollapsed, setIsCollapsed }) {
  ...
  return (
    <div
      className={`${isCollapsed ? 'md:w-16' : 'md:w-64'} hidden md:flex md:flex-col md:fixed md:inset-y-0 transition-all duration-300 ease-in-out`}
    >
            ...
            <div className="mt-8 px-2">
              ...
              <div className="mt-2 space-y-1">
                {projects.map(project => (
                  ...
                  >
                    <span
                      className={`w-2.5 h-2.5 mr-3 rounded-full ${project.color}`}
                      aria-hidden="true"
                    />
                    {project.name}
                  </a>
