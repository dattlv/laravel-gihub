...
export default function Navbar({ user, showingNavigationDropdown, setShowingNavigationDropdown, isSidebarCollapsed }) {
    return (
        <nav className="bg-white border-b border-gray-100">
            <div className={`${isSidebarCollapsed ? 'md:pl-16' : 'md:pl-64'} transition-all duration-300`}>
