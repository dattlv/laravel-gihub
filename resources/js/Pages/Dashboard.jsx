            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
                        ...
                        {/* Completed Tasks */}
                        <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            <div className="text-gray-500 text-sm font-medium">Completed Tasks</div>
                            <div className="mt-2 flex items-baseline">
                        ...
                        {/* Ongoing Projects */}
                        <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            <div className="text-gray-500 text-sm font-medium">Ongoing Projects</div>
                            <div className="mt-2 flex items-baseline">
                                ...
                                <div className="ml-2 flex items-baseline text-sm font-semibold text-yellow-600">
                                    <svg className="self-center flex-shrink-0 h-5 w-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                                                ...
                                                <div className="flex items-center space-x-4">
                                                    <div className="flex-shrink-0">
                                                        <span className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-green-100">
                                                            <span className="text-sm font-medium leading-none text-green-600">UI</span>
                                                        </span>
                                                    </div>
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-sm font-medium text-gray-900 truncate">Design New Dashboard Layout</p>
                                                ...
                                                <div className="flex items-center space-x-4">
                                                    <div className="flex-shrink-0">
                                                        <span className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-blue-100">
                                                            <span className="text-sm font-medium leading-none text-blue-600">API</span>
                                                        </span>
                                                    </div>
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-sm font-medium text-gray-900 truncate">Implement Authentication API</p>
                                        ...
                                        <ul className="-my-5 divide-y divide-gray-200">
                                            <li className="py-4">
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-sm font-medium text-gray-900 truncate">Project Milestone Review</p>
                                            ...
                                            <li className="py-4">
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-sm font-medium text-gray-900 truncate">Team Weekly Sync</p>
                                                ...
                                                <div className="relative pb-8">
                                                    ...
                                                    <div className="relative flex space-x-3">
                                                        ...
                                                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                            <div>
                                                                <p className="text-sm text-gray-500">New task <span className="font-medium text-gray-900">Website Redesign</span> created</p>
                                                            </div>
